  ...
  tabsetPanel(
    ...
    tabPanel("Report", fluid = TRUE,
             ...
             # better understanding of our shiny app. 
               fluidRow(column(6, radioButtons("reportUniv", 
                                  label = h3("University Rating (Level of Difficulty)"),
                                  choices = list("Very Competitive" = 5, 
                                                 "Competitive" = 4,
                                                  "Average" = 3,
                               ...
                               plotOutput("report_gre", height = "250px", width = "80%"), hr(width = "80%", align = "left"),
                        ...
                        # Start of second column, right side of our 'Report' layout. 
                          column(6, 
                            tags$div(
                              ...
                              tags$h4("If you have not noticed already, our team has re-introduced a widget in which alters difficulty of the Graduate school the user is looking to apply for. By 
